...
urlpatterns = [
    # path('api/wish_message/<int:id>/', WishMessageView.as_view(), name='wish-message'), # custom crud
    # path('api/wish_message/', WishMessageCreateListView.as_view(), name='wish-message'), # custom crud
